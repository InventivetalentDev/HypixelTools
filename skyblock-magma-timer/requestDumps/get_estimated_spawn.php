...
if (!($stmt = $conn->prepare("SELECT type,time_rounded,confirmations,time_average FROM hypixel_skyblock_magma_timer_events2 WHERE confirmations >= ? AND time_rounded > ? ORDER BY time_rounded DESC, confirmations DESC LIMIT 30"))) {
